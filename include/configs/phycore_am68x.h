...
#define EXTRA_ENV_PHYCORE_AM68X_BOARD_SETTINGS					\
	"default_device_tree=k3-am68-phyboard-izar-rdk.dtb\0"	\
	"findfdt="							\
...
#define EXTRA_ENV_PHYCORE_AM68X_BOARD_SETTINGS_MMC				\
	...
	"get_fdt_mmc=load mmc ${bootpart} ${fdtaddr} ${name_fdt}\0" \
	"get_overlay_mmc="						\
		"fdt address ${fdtaddr};"				\
		"fdt resize 0x100000;"					\
		"for overlay in $name_overlays;"			\
		"do;"							\
		"load mmc ${bootpart} ${dtboaddr} ${overlay} && "	\
		"fdt apply ${dtboaddr};"				\
		"done;\0"						\
...
#endif /* CONFIG_TARGET_PHYCORE_AM68X_A72 */
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
	...
	DEFAULT_MMC_TI_ARGS						\
	DEFAULT_FIT_TI_ARGS						\
	EXTRA_ENV_PHYCORE_AM68X_BOARD_SETTINGS					\
	EXTRA_ENV_PHYCORE_AM68X_BOARD_SETTINGS_MMC				\
