...
struct phytec_api3_element *phytec_blocks_init_mac(
		struct phytec_api3_block_header *header, uint8_t *payload)
{
...
int __maybe_unused phytec_blocks_add_mac_to_env(
					struct phytec_api3_element *element)
{
...
inline struct phytec_api3_element *phytec_api3_init_mac_block(
		struct phytec_api3_block_header *header, uint8_t *payload) {
	return NULL;
}

inline int __maybe_unused phytec_blocks_add_mac_to_env(
					struct phytec_api3_element *element) {
	return -1;
}
