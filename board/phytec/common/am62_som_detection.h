...
#ifndef _PHYTEC_AM62_SOM_DETECTION_H
#define _PHYTEC_AM62_SOM_DETECTION_H
...
inline u8 __maybe_unused phytec_get_am62_ddr_size(
...
inline u8 __maybe_unused phytec_get_am62p_rtc(
		struct phytec_eeprom_data *data)
{
	return PHYTEC_EEPROM_INVAL;
}
